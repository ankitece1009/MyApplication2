...
public class MainActivity extends AppCompatActivity {
  ...
  /*  void WriteIntoFile()
        ...
        LV.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(chosen.equals(correct)) {
                    points++;
                    Toast.makeText(getApplicationContext(), "AweSome! Points="+points, Toast.LENGTH_SHORT).show();
                }
                else {
                    points--;
                    Toast.makeText(getApplicationContext(), ":-{,In correct. Points="+points, Toast.LENGTH_SHORT).show();
                }
                wordGame();
            }
        });
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
            ...
            points = (int)savedInstanceState.get("points");
    }

    public void AddNewWordToFile(View view) {
